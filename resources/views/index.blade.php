    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('admin') }}"><img src="{{ asset(url('images/logo.png')) }}" alt="Logo"></a>
                <a class="navbar-brand hidden" href="{{ url('admin') }}"><img src="{{ asset(url('images/logo2.png')) }}" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{ url('admin') }}" title="Dashboard"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Other admin"> <i class="menu-icon fa fa-user"></i>Other admin</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-user-plus"></i><a href="{{ url('admin/user/create') }}">Add new admin</a></li>
                            <li><i class="menu-icon fa fa-users"></i><a href="{{ url('admin/user') }}">List admin</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ url('admin/user/profile/'.$user['id']) }}" title="My profile"> <i class="menu-icon ti-id-badge"></i>My profile </a>
                    </li>
                    <li>
                        <a href="" title="Notification"> <i class="menu-icon fa fa-bell"></i>Notification </a>
                    </li>
                    <li>
                        <a href="" title="Mails"> <i class="menu-icon ti-email"></i>Mails </a>
                    </li>
                    <li>
                        <a href="{{ url('admin/logout') }}" title="Logout"><i class="menu-icon ti-shift-right"></i>Logout </a>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset(url('images/admin.jpg')) }}" alt="User Avatar">
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                                ...
                                <a class="nav-link" href="#"><i class="fa fa -cog"></i>Mails <span class="count">9</span></a>
