			...
			<div class="col-md-7 section-center mt-5">
					...
					<div class="col-md-7">
						<fieldset class="form-control mb-5">
							...
							<div class="row mt-3 text-center">
								<div class="col-md-3">
									<img src="<?php echo e(asset(url('upload/user/man.png'))); ?>" class="rounded-circle" width="30">
								</div>
								<div class="col-md-6">
									Nguyen Van A
								</div>
				...
				<div class="row mb-5">
					<fieldset class="form-control col-md-10 offset-1">
						...
						<div class="row">
							<div class="col-md-3">
								<a href="<?php echo e(url('index/toeic/test/'.$part.'/'.$id)); ?>" class="btn btn-outline-success col-md-10 mb-3"><i>Đề thi 1</i></a>
							</div>
							<div class="col-md-3">
								<a href="thitoeic.html" class="btn btn-outline-success col-md-10 mb-3"><i>Đề thi 2</i></a>
							</div>
