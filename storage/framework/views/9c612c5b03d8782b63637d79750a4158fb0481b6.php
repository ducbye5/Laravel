							...
							<ul>
								<li>
									...
									<div class="header-menu">
										<ul>
											<li>
												<a href="<?php echo e(url('index/toeic')); ?>">Toeic</a>
											</li>
											<li>
												<a href="">Ielts</a>
											</li>
						...
						<div class="col-md-2  text-right">
								<div class="dropdown mt-2">
									<div  class="dropdown-toggle" data-toggle="dropdown">
										<img src="<?php echo e(asset(url('upload/user/'.$customer->customer_img))); ?>" class="rounded-circle" width="30">
									...
									<div class="dropdown-menu">
										...
										<a href="<?php echo e(url('index/logout')); ?>" class="dropdown-item">
