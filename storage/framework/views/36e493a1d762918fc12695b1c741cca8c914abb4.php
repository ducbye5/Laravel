...
<nav class="navbar navbar-dark bg-dark flex-md-nowrap p-0 sticky-top">
	<a href="<?php echo e(url('admin/layout')); ?>" class="navbar-brand col-md-2 col-sm-3 mr-0 text-center">
		<h4>Modus</h4>
	</a>
	...
	<ul class="navbar-nav px-3">
		<li class="nav-item text-nowrap">
			<a href="<?php echo e(url('admin/logout')); ?>" class="nav-link">Sign Out</a>
		</li>
	</ul>
</nav>
		...
		<nav class="col-md-3 col-lg-2 sidebar bg-light p-0">
			<div class="sidebar-sticky">
				<div class="text-center">
					...
					<a href="<?php echo e(url('admin/adminstrator/profile/'.$user->user_id)); ?>"><img src="<?php echo url('upload/user/'. $user->user_img); ?>" alt="picturel" class="rounded-circle" width="100px" height="100px"></a>
					<p><i><?php echo e($user->user_name); ?></i></p>
				</div>
				<ul class="nav flex-column">
					<li class="nav-item">
						<a href="<?php echo e(url('admin/layout')); ?>" class="nav-link">
							<span class="pe-7s-home"></span>Home
						</a>
					</li>
					<li class="nav-item">
						<a href="<?php echo e(url('admin/toeic')); ?>" class="nav-link">
					...
					<li class="nav-item">
						<a href="<?php echo e(url('admin/adminstrator')); ?>" class="nav-link">
